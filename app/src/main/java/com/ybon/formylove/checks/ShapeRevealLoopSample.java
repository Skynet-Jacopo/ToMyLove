...
public class ShapeRevealLoopSample {
	public static void play(TextSurface textSurface) {
		...
		Text textA = TextBuilder.create("Now why you loer en kyk gelyk?").setSize(44).setPosition
				(Align.SURFACE_CENTER).build();
		Text textB = TextBuilder.create("Is ek miskien van goud gemake?").setSize(44).setPosition
				(Align.BOTTOM_OF | Align.CENTER_OF, textA).build();
		Text textC = TextBuilder.create("You want to fight, you come tonight.").setSize(44)
				.setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textB).build();
		Text textD = TextBuilder.create("Ek moer jou sleg! So jy hardloop weg.").setSize(44)
